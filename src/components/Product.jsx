...
const Product = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `https://ecom-q0mb.onrender.com/api/product/${id}`
        );
    ...
    const fetchImage = async () => {
      const response = await axios.get(
        `https://ecom-q0mb.onrender.com/api/product/${id}/image`,
        { responseType: "blob" }
      );
  ...
  const deleteProduct = async () => {
    try {
      await axios.delete(`https://ecom-q0mb.onrender.com/api/product/${id}`);
      removeFromCart(id);
